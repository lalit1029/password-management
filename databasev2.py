...
def main():
    ...
    #db1.insert(dict(ROW_ID = 101, username = 'user1.login@domain.com', password = 'UserPassword123', masterenc=None))
    #db1.insert(dict(ROW_ID = 102, username = 'user2@domain.com', password = 'UserPassword456', masterenc=None))
    #print(db1.retrieve_rows())
    usertabledb=str()
    print("---------------------All Databases re-initialized------------------------------")
